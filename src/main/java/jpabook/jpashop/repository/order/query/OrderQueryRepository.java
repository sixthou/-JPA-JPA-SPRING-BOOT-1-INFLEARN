...
public class OrderQueryRepository {
    ...
    public List<OrderQueryDto> findAllByDto_optimization() {
        ...
        Map<Long, List<OrderItemQueryDto>> collect = findOrderItemMap(toOrderItds(result));
    ...
    private Map<Long, List<OrderItemQueryDto>> findOrderItemMap(List<Long> orderIds) {
        ...
        Map<Long, List<OrderItemQueryDto>> collect = orderItems.stream().collect(Collectors.groupingBy(OrderItemQueryDto::getOrderId));
        return collect;
    }

    private static List<Long> toOrderItds(List<OrderQueryDto> result) {
